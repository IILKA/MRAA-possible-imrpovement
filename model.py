...
#Mean and std values of mgif
#Mean: [0.10593732 0.10593732 0.10593732]
#Std: [0.3261177 0.3261177 0.3261177]  
...
#         self.conv = resnet152.conv1
#         self.slice1 = torch.nn.Sequential(resnet152.layer0)
#         self.slice2 = torch.nn.Sequential(resnet152.layer1)
#         self.slice3 = torch.nn.Sequential(resnet152.layer2)
#         self.slice4 = torch.nn.Sequential(resnet152.layer3)
#         self.slice5 = torch.nn.Sequential(resnet152.layer4)
